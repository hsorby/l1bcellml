/* The content of this file was generated using the C profile of libCellML 0.3.3. */

#include "model.computed.constant.h"

#include <math.h>
#include <stdlib.h>

const char VERSION[] = "0.3.0";
const char LIBCELLML_VERSION[] = "0.3.3";
...
void initialiseVariables(double voi, double *states, double *variables, ExternalVariable externalVariable)
{
    ...
    states[2] = 0.325;
    states[3] = 0.0;
    variables[6] = externalVariable(voi, states, variables, 6);
}
