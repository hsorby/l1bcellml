...
curl -L https://www.python.org/ftp/python/3.7.9/Python-3.7.9.tgz > $downloads_dir/Python-3.7.9.tar.gz
...
tar -xzf $downloads_dir/Python-3.7.9.tar.gz
...
$work_dir/openssl-1.1.1h/config
make -j3
make install

cd $src_dir/Python-3.7.9/
