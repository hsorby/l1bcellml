...
set(HAVE_LIBXML2_CONFIG FALSE)
  ...
  if(LibXml2_FOUND)
    ...
    get_property(_INC_DIR TARGET xml2 PROPERTY INCLUDE_DIRECTORIES)
    get_property(_INT_INC_DIR TARGET xml2 PROPERTY INTERFACE_INCLUDE_DIRECTORIES)
    message(STATUS "_INC_DIR: ${_INC_DIR}")
    message(STATUS "_INT_INC_DIR: ${_INT_INC_DIR}")
  else()
